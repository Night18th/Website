...
export default class Navb extends Component {
    ...
    render() {
      ...
      <Navbar collapseOnSelect expand="lg" fixed="top" id="nav">
        <Container>
          <Navbar.Brand><div id="logo">Step Up EDR</div></Navbar.Brand>
          ...
          <Navbar.Collapse className="basic-navbar-nav" id="nogrow">
            <Nav className="me-auto">
              ...
              <Nav.Link href="/calendarnew"><Button id="button"><span id="bold">Calendar</span></Button></Nav.Link>
              <DarkMode />
            </Nav>
          </Navbar.Collapse>
        </Container>
      ...
      <Switch>
        ...
        <Route path="/calendarnew" exact component={Calendarnew} /> 
      </Switch>
      </div>
      </Router>
        )
